...
class ContactListAdapter(activity: FragmentActivity) : RecyclerView.Adapter<ContactListAdapter.CustomView>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ContactListAdapter.CustomView {

        return CustomView(LayoutInflater.from(context).inflate(R.layout.recycler_item_chat_list, parent, false))
    }
